...
public class ForumService {
    ...
    public void addNewTopic(String topicTitle, String topicContent, User loginUser) {
        int lastId = topics.size();
        Topic newTopic = new Topic(lastId + 1, topicTitle, topicContent, loginUser, null);
